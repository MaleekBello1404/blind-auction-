# blind-auction- This is basically a auction program where users get to type in their highest bid for a particular item and the program will check to see whose bid is the highest
